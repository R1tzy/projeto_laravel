    ...
    <div class="bg-gray-800 p-[20px] font-['Arial'] text-[16px]">
        <form action="{{route('Fornecedor.store')}}" method="POST">
            ...
            <div class="mb-[10px] basis-1">
                ...
                <x-input name="nome" class="mt-[5px] w-[200px] h-[30px] pl-[0]" placeholder="Empresa Kabum"></x-input>

                <x-label class="text-[#fff]">Informe o nome fantasia</x-label>
                <x-input name="fantasia" class="mt-[5px] w-[200px] h-[30px] pl-[0]" placeholder="Kabum"></x-input>

                <x-label class="text-[#fff]">Informe o cnpj</x-label>
                <x-input name="cnpj" class="mt-[5px] w-[200px] h-[30px] pl-[0]" type="text" pattern="[0-9]{14}" placeholder="99345869000135"></x-input>

                <x-label class="text-[#fff]">Informe o Endereço</x-label>
                <x-input name="endereco" class="mt-[5px] w-[200px] h-[30px] pl-[0]" placeholder="Rua Osvaldo 1261"></x-input>

                <x-label class="text-[#fff]">Informe o Telefone</x-label>
                <x-input name="telefone" class="mt-[5px] w-[200px] h-[30px] pl-[0]" type="tel" pattern="[0-9]{9}" placeholder="988294370"></x-input>
